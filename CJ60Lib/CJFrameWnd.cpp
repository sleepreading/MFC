...
IMPLEMENT_DYNAMIC(CCJFrameWnd, CFrameWnd)
...
BOOL CCJFrameWnd::InstallCoolMenus(CWnd* pParentWnd, UINT nNum, const UINT* nBars)
{
	ASSERT(pParentWnd);
...
BOOL CCJFrameWnd::InstallCoolMenus(CWnd * pParentWnd, UINT nBar)
{
	ASSERT(pParentWnd);
	m_pMenuMgr.Install ((CFrameWnd*)pParentWnd);
